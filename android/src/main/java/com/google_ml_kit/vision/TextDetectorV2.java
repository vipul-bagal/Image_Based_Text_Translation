...
//                    break;
//            case 5: textRecognizer = TextRecognition.getClient(new ArabicTextRecognizerOptions.Builder().build());
//                break;
//            case 6: textRecognizer = TextRecognition.getClient(new TeluguTextRecognizerOptions.Builder().build());
//                break;
//            case 7: textRecognizer = TextRecognition.getClient(new TamilTextRecognizerOptions.Builder().build());
